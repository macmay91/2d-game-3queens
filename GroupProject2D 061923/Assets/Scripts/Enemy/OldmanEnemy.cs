...
public class OldmanEnemy : MonoBehaviour
{
    ...
    private bool PlayerInSight()
    {
        ...
        RaycastHit2D hit = Physics2D.BoxCast(oldmanCollider.bounds.center + hitOffset * transform.localScale.x, oldmanCollider.bounds.size + new Vector3 (.5f, 0, 0), 0, Vector2.left, 0, playerLayer);
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireCube(oldmanCollider.bounds.center + hitOffset * transform.localScale.x, oldmanCollider.bounds.size + new Vector3(.5f, 0, 0));
    }
